 ...
 *      Date:    2015
 *
 *      A very basic color class that can parse a color string
 *      in the hex format '#rrggbb' within its constructor.
 *
 *********************************************************************/
...
public class GraphColor
{
 ...
 public GraphColor(String hexValue)
 {
  int index;
  ...
  if (index >= 0)
  {
   hexValue = hexValue.substring(index + 1,
                                 hexValue.lastIndexOf("\""));
  }
